...
The deployment url is: [https://arquisoft.github.io/wiq_en3a/](https://arquisoft.github.io/wiq_en3a/).
...
If we want to deploy it to GitHub pages, so it is accessible via [https://arquisoft.github.io/wiq_en3a/](https://arquisoft.github.io/wiq_en3a/), we need to execute `npm run deploy`.
